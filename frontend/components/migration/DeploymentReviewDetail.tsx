    ...
    <div className={styles.container}>
      ...
      <div className={styles.workspaceGrid}>
        ...
        <div className={styles.rightPanel}>
          ...
          <div className={styles.sideCard}>
            <div className={styles.cardHeader}>
              <h3 className={styles.cardTitle}>
                <ShieldCheck size={16} style={{ color: "#3b82f6" }} /> Validation Panel
              </h3>
              <div className={styles.validationPills}>
                <span className={`${styles.valPill} ${styles.valErrPill}`}>
                  Errors {validationResult.errors.length}
                </span>
                <span className={`${styles.valPill} ${styles.valWarnPill}`}>
                  Warnings {validationResult.warnings.length}
                </span>
                <span className={`${styles.valPill} ${styles.valSuggPill}`}>
            ...
            <div className={styles.issuesList}>
              {validationResult.errors.map((err, i) => (
                ...
                >
                  <div className={styles.issueHeader}>
                    ...
                    <span className={styles.issueLine}>Line {err.line}</span>
                  </div>
                  <div className={styles.issueMsg}>{err.message}</div>
                </div>
              ))}
              ...
              {validationResult.warnings.map((warn, i) => (
                <div
                  ...
                  onClick={() => handleJumpToLine(warn.line)}
                >
                  <div className={styles.issueHeader}>
                    ...
                    <span className={styles.issueLine}>Line {warn.line}</span>
                  </div>
                  <div className={styles.issueMsg}>{warn.message}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className={styles.sideCard}>
            <h3 className={styles.cardTitle}>
              <CheckCircle2 size={16} style={{ color: "#10b981" }} /> Deployment Readiness
            </h3>

            <div className={styles.checklist}>
              <div className={styles.checkItem}>
                <span className={styles.checkLabel}>
                  <Check size={14} className={styles.checkPassIcon} /> Schema Valid
                </span>
                <span style={{ color: validationResult.isValid ? "#10b981" : "#ef4444", fontWeight: 700 }}>
                  {validationResult.isValid ? "PASS" : "FAIL"}
                </span>
              </div>
              <div className={styles.checkItem}>
                <span className={styles.checkLabel}>
                  <Check size={14} className={styles.checkPassIcon} /> JSON Syntax Valid
                </span>
                <span style={{ color: validationResult.isValid ? "#10b981" : "#ef4444", fontWeight: 700 }}>
                  {validationResult.isValid ? "PASS" : "FAIL"}
                </span>
              ...
              <div className={styles.checkItem}>
                <span className={styles.checkLabel}>
                  <Check size={14} className={styles.checkPassIcon} /> Datasets Verified
                </span>
                <span style={{ color: "#10b981", fontWeight: 700 }}>VERIFIED</span>
              </div>
              <div className={styles.checkItem}>
                <span className={styles.checkLabel}>
                  <Check size={14} className={styles.checkPassIcon} /> Warehouse Configured
                </span>
                <span style={{ color: "#10b981", fontWeight: 700 }}>ACTIVE</span>
              </div>
              <div className={styles.checkItem}>
                <span className={styles.checkLabel}>
                  <Check size={14} className={styles.checkPassIcon} /> Unity Catalog Objects Found
                </span>
                <span style={{ color: "#10b981", fontWeight: 700 }}>FOUND</span>
              </div>

              <div
                className={`${styles.overallReadyBadge} ${
                  validationResult.isValid ? styles.overallYes : styles.overallNo
                }`}
              >
                {validationResult.isValid ? (
                  <>
                    <CheckCircle2 size={18} /> READY TO PUBLISH: YES
                  </>
                ) : (
                  <>
                    <X size={18} /> READY TO PUBLISH: NO
                  </>
                )}
              </div>
            </div>
          ...
          {/* Dynamic Databricks Compatibility Card */}
          <div className={styles.sideCard}>
            <h3 className={styles.cardTitle}>
              <Server size={16} style={{ color: "#f59e0b" }} /> Databricks Connection
            </h3>

            <div className={styles.compatGrid}>
              <div className={styles.compatBox}>
                <span className={styles.compatLabel}>Lakeview Version</span>
                <span className={styles.compatVal}>3.0</span>
              </div>
              <div className={styles.compatBox}>
                <span className={styles.compatLabel}>Catalog</span>
                <span className={styles.compatVal}>{connectionInfo.catalog}</span>
              </div>
              <div className={styles.compatBox}>
                <span className={styles.compatLabel}>Warehouse</span>
                <span className={styles.compatVal} style={{ fontSize: "0.75rem" }}>
                  {connectionInfo.warehouse_id}
                </span>
              </div>
              <div className={styles.compatBox}>
                <span className={styles.compatLabel}>Unity Catalog</span>
                <span className={styles.compatVal} style={{ color: "#10b981" }}>
                  Enabled
                </span>
              </div>
            </div>
          ...
          {/* Dynamic Deployment Preview Object Count Grid */}
          <div className={styles.sideCard}>
            <h3 className={styles.cardTitle}>
              <FileCheck size={16} style={{ color: "#8b5cf6" }} /> Deployment Objects
            </h3>

            <div className={styles.previewGrid}>
              <div className={styles.previewBox}>
                <span className={styles.previewNum}>{objectCounts.dashboards}</span>
                <span className={styles.previewLabel}>Dashboard</span>
              </div>
              <div className={styles.previewBox}>
                <span className={styles.previewNum}>{objectCounts.pages}</span>
                <span className={styles.previewLabel}>Pages</span>
              </div>
              <div className={styles.previewBox}>
                <span className={styles.previewNum}>{objectCounts.widgets}</span>
                <span className={styles.previewLabel}>Widgets</span>
              </div>
              <div className={styles.previewBox}>
                <span className={styles.previewNum}>{objectCounts.queries}</span>
                <span className={styles.previewLabel}>Queries</span>
              </div>
              <div className={styles.previewBox}>
                <span className={styles.previewNum}>{objectCounts.datasets}</span>
                <span className={styles.previewLabel}>Datasets</span>
              </div>
            </div>
          </div>
        </div>
